...
do
	echo $CHROM
	Rscript run_edger.R chr$CHROM"_edgeR_table".tsv chr$CHROM"_edgeR_output".tsv
	python get_sig.py chr$CHROM"_edgeR_output".tsv
done
...
if [ ! -e wgEncodeBroadHistoneGm12878H3k27me3StdPkV2_100kb_windows_enrichment.bed ]
	then 
		...
		bedtools coverage -a $WINDOW_FILE -b wgEncodeBroadHistoneGm12878H3k27me3StdPkV2.broadPeak > wgEncodeBroadHistoneGm12878H3k27me3StdPkV2_100kb_windows_enrichment.bed
fi

if [ ! -e wgEncodeBroadHistoneK562H3k27me3StdPk_100kb_windows_enrichment.bed ]
	then 
