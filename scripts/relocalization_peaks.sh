...
for i in `seq 0 20`
do
	python ../relocalization_peaks.py hic_data/GM12878_combined_${CHROMS[$i]}_100kb.bed hic_data/K562_${CHROMS[$i]}_100kb.bed -m $((${MIDPOINTS[$i]} * 1000000)) -N ${PARTITION_NUMS[$i]} -s ${SMOOTHING_PARAMETERS[$i]} -x ../
done
