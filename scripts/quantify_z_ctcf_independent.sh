...
if [ -e ctcf_independent_design.txt ]
	then
		rm ctcf_independent_design.txt
fi

for CELLTYPE1 in mESC-WT-rep1 mESC-WT-rep2
do
	echo $CELLTYPE1" mESC-CTCF-KO-rep1" >> ctcf_independent_design.txt
done

python quantify_z_independent.py 20 ctcf_independent_design.txt 0.015
