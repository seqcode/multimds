...
if [ ! -s GSM2583738_asy_r1.counts.txt ]
	then
...
if [ ! -s GSM2583739_asy_r2.counts.txt ]
	then
...
if [ ! -s GSM2583740_asy_r3.counts.txt ]
	then
...
if [ ! -s GSM2583741_gal_r1.counts.txt ]
	then
...
if [ ! -s GSM2583742_gal_r2.counts.txt ]
	then
...
if [ ! -s GSM2583743_gal_r3.counts.txt ]
	then
