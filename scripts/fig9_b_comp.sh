...
do
	...
	bedtools coverage -a peaks_b_comp_filtered.bed -b binding_data/$FILENAME > peaks_b_comp_filtered_GM12878_${NAME}_coverage.bed
	bedtools coverage -a B_background_filtered.bed -b binding_data/$FILENAME > B_background_filtered_GM12878_${NAME}_coverage.bed
done
...
do
	...
	bedtools coverage -a peaks_b_comp_filtered.bed -b binding_data/$FILENAME > peaks_b_comp_filtered_K562_${NAME}_coverage.bed
	bedtools coverage -a B_background_filtered.bed -b binding_data/$FILENAME > B_background_filtered_K562_${NAME}_coverage.bed
done

for STATE in polycomb enhancer transcription
do
	for CELLTYPE in GM12878 K562
	do
		bedtools coverage -a peaks_b_comp_filtered.bed -b binding_data/${CELLTYPE}_${STATE}.bed > peaks_b_comp_filtered_${CELLTYPE}_${STATE}_coverage.bed
		bedtools coverage -a B_background_filtered.bed -b binding_data/${CELLTYPE}_${STATE}.bed > B_background_filtered_${CELLTYPE}_${STATE}_coverage.bed
	done
done

python fig9_b_comp.py
