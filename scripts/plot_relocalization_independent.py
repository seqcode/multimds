...
os.system("python ../minimds.py -w 0 -o independent_ctrl_{}_{}kb_structure.tsv hic_data/ctrl_{}_{}kb.bed".format(chrom_name, res_kb, chrom_name, res_kb))
os.system("python ../minimds.py -w 0 -o independent_galactose_{}_{}kb_structure.tsv hic_data/galactose_{}_{}kb.bed".format(chrom_name, res_kb, chrom_name, res_kb))
