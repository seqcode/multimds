...
plot.plot_structures_interactive((struct1, struct2), out_path="sup5a.png")
...
plot.plot_structures_interactive((struct1, struct2), out_path="sup5b_upstream.png")
...
plot.plot_structures_interactive((struct1, struct2), out_path="sup5b_downstream.png")
