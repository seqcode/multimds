...
do
	...
	python plot_3d_yeast.py rDNA 12-downstream 448000 $STRAIN ""
done
...
python plot_3d_yeast.py Gal2 12-upstream 290212 Scer ""

python ../multimds.py -P 0.1 -w 0 hic_data/ctrl_Suva_15_32kb.bed hic_data/galactose_Suva_15_32kb.bed
python plot_3d_yeast.py Gal2 15 740086 Suva ""
