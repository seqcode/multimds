...
marks = ("H3K27ac", "H3K4me1", "H3K4me3", "H3K9ac", "H3K36me3", "H2AZ", "H3K79me2", "H3K27me3", "EZH2", "polycomb", "enhancer", "transcription")
...
for i, dataset in enumerate(datasets):
	peaks_coverage = np.loadtxt("peaks_a_comp_filtered_{}_coverage.bed".format(dataset), usecols=8)
	background_coverage = np.loadtxt("A_background_filtered_{}_coverage.bed".format(dataset), usecols=8)
