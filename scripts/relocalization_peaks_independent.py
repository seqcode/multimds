...
os.system("python ../minimds.py -o hic_data/{}_{}_{}kb_independent_structure.tsv {}".format(cell_type1, chrom, res_kb, path1))
os.system("python ../minimds.py -o hic_data/{}_{}_{}kb_independent_structure.tsv {}".format(cell_type2, chrom, res_kb, path2))
