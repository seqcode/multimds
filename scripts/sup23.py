...
for i, dataset in enumerate(datasets):
	peaks_coverage = np.loadtxt("peaks_b_comp_filtered_{}_coverage.bed".format(dataset), usecols=8)
	background_coverage = np.loadtxt("B_background_filtered_{}_coverage.bed".format(dataset), usecols=8)
