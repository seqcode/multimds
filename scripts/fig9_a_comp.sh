...
do
	...
	bedtools coverage -a peaks_a_comp_filtered.bed -b binding_data/$FILENAME > peaks_a_comp_filtered_GM12878_${NAME}_coverage.bed
...
do
	...
	bedtools coverage -a peaks_a_comp_filtered.bed -b binding_data/$FILENAME > peaks_a_comp_filtered_K562_${NAME}_coverage.bed
...
do
	...
	do
		bedtools coverage -a peaks_a_comp_filtered.bed -b binding_data/${CELLTYPE}_${STATE}.bed > peaks_a_comp_filtered_${CELLTYPE}_${STATE}_coverage.bed
