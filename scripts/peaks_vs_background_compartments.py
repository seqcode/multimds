...
#plot data
plt.boxplot(ys, positions=(0, 0.5), notch=True, patch_artist=True, labels=("Background", "Relocalized"), medianprops=dict(linestyle="none"))	#boxplot has built-in support for labels, unlike barplot
...
#plot ticks
plt.tick_params(direction="out", top=False, right=False, length=12, width=3, pad=1, labelsize=8)
